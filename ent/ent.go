...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			applicantinterest.Table:     applicantinterest.ValidColumn,
			applicantprofile.Table:      applicantprofile.ValidColumn,
			applicantprofileskill.Table: applicantprofileskill.ValidColumn,
			application.Table:           application.ValidColumn,
			category.Table:              category.ValidColumn,
			contactusmessage.Table:      contactusmessage.ValidColumn,
			degreelevel.Table:           degreelevel.ValidColumn,
			education.Table:             education.ValidColumn,
			interview.Table:             interview.ValidColumn,
			joboffer.Table:              joboffer.ValidColumn,
			joboffercategory.Table:      joboffercategory.ValidColumn,

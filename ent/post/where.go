...
// IsHighlighted applies equality check predicate on the "is_highlighted" field. It's identical to IsHighlightedEQ.
func IsHighlighted(v bool) predicate.Post {
	return predicate.Post(sql.FieldEQ(FieldIsHighlighted, v))
}
...
// IsHighlightedEQ applies the EQ predicate on the "is_highlighted" field.
func IsHighlightedEQ(v bool) predicate.Post {
	return predicate.Post(sql.FieldEQ(FieldIsHighlighted, v))
}

// IsHighlightedNEQ applies the NEQ predicate on the "is_highlighted" field.
func IsHighlightedNEQ(v bool) predicate.Post {
	return predicate.Post(sql.FieldNEQ(FieldIsHighlighted, v))
}
